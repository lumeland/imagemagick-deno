...
import { NativeMontageSettings } from "./native-montage-settings.ts";
...
export class MontageSettings {
  ...
  /** @internal */
  _use<TReturnType>(
    func: (settings: NativeMontageSettings) => TReturnType,
  ): TReturnType;
  /** @internal */
  _use<TReturnType>(
    func: (settings: NativeMontageSettings) => Promise<TReturnType>,
  ): Promise<TReturnType>;
  _use<TReturnType>(
    func: (
      settings: NativeMontageSettings,
