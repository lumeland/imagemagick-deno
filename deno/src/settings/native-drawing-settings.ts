  ...
  constructor(settings: DrawingSettings) {
    ...
    if (settings.fillColor !== undefined) {
      settings.fillColor._use((valuePtr) => {
        ImageMagick._api._DrawingSettings_FillColor_Set(
          this._instance,
          valuePtr,
        );
      });
    ...
    if (settings.fontPointsize !== undefined) {
      ImageMagick._api._DrawingSettings_FontPointsize_Set(
        this._instance,
    ...
    if (settings.strokeColor !== undefined) {
      settings.strokeColor._use((valuePtr) => {
        ImageMagick._api._DrawingSettings_StrokeColor_Set(
          this._instance,
          valuePtr,
        );
      });
    ...
    if (settings.strokeWidth !== undefined) {
      ImageMagick._api._DrawingSettings_StrokeWidth_Set(
        this._instance,
