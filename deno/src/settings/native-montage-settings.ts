...
import { MontageSettings } from "./montage-settings.ts";
  ...
  constructor(settings: MontageSettings) {
    ...
    if (settings.backgroundColor !== undefined) {
      settings.backgroundColor._use((valuePtr) => {
        ImageMagick._api._MontageSettings_SetBackgroundColor(
          this._instance,
          valuePtr,
        );
      });
    ...
    if (settings.borderColor !== undefined) {
      settings.borderColor._use((valuePtr) => {
        ImageMagick._api._MontageSettings_SetBorderColor(
          this._instance,
          valuePtr,
        );
      });
    ...
    if (settings.borderWidth !== undefined) {
      ImageMagick._api._MontageSettings_SetBorderWidth(
        this._instance,
    ...
    if (settings.fillColor !== undefined) {
      settings.fillColor._use((valuePtr) => {
        ImageMagick._api._MontageSettings_SetFillColor(
          this._instance,
          valuePtr,
        );
      });
    ...
    if (settings.fontPointsize !== undefined) {
      ImageMagick._api._MontageSettings_SetFontPointsize(
        this._instance,
    ...
    if (settings.frameGeometry !== undefined) {
      _withString(settings.frameGeometry.toString(), (geometryPtr) => {
        ImageMagick._api._MontageSettings_SetFrameGeometry(
          this._instance,
          geometryPtr,
        );
      });
    ...
    if (settings.geometry !== undefined) {
      _withString(settings.geometry.toString(), (geometryPtr) => {
        ImageMagick._api._MontageSettings_SetGeometry(
          this._instance,
          geometryPtr,
        );
      });
    ...
    if (settings.gravity !== undefined) {
      ImageMagick._api._MontageSettings_SetGravity(
        this._instance,
        settings.gravity,
      );
    }
    ...
    if (settings.shadow !== undefined) {
      ImageMagick._api._MontageSettings_SetShadow(
        this._instance,
        settings.shadow ? 1 : 0,
      );
    }
    ...
    if (settings.strokeColor !== undefined) {
      settings.strokeColor._use((valuePtr) => {
        ImageMagick._api._MontageSettings_SetStrokeColor(
          this._instance,
          valuePtr,
        );
      });
    ...
    if (settings.textureFileName !== undefined) {
      _withString(settings.textureFileName, (ptr) => {
        ImageMagick._api._MontageSettings_SetTextureFileName(
          this._instance,
          ptr,
        );
      });
    ...
    if (settings.tileGeometry !== undefined) {
      _withString(settings.tileGeometry.toString(), (geometryPtr) => {
        ImageMagick._api._MontageSettings_SetTileGeometry(
          this._instance,
          geometryPtr,
        );
      });
