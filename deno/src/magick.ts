...
import { LogEventTypes } from "./log-event-types.ts";
...
export class Magick {
  ...
  static get delegates(): string {
    return _createString(ImageMagick._api._Magick_Delegates_Get(), "Unknown");
  }

  static get features(): string {
    return _createString(ImageMagick._api._Magick_Features_Get(), " ").slice(
      0,
      -1,
    );
  }
  ...
  static setLogEvents(eventTypes: LogEventTypes): void {
    if (Magick._logDelegate === undefined) {
      Magick._logDelegate = ImageMagick._api.addFunction(
        Magick.logDelegate,
        "vii",
      );
    ...
    _withString(
      eventTypeString,
      (instance) => ImageMagick._api._Magick_SetLogEvents(instance),
    );
  }
  ...
  private static logDelegate(eventType: number, message: number): void {
    ...
    Magick.onLog(
      new LogEvent(eventType as LogEventTypes, _createString(message, "")),
    );
  }
  ...
  private static getEventTypeString(eventType: LogEventTypes): string {
    if (eventType == LogEventTypes.All) {
      ...
      return "All";
        ...
        case LogEventTypes.Accelerate:
          return "Accelerate";
        case LogEventTypes.Annotate:
          return "Annotate";
        case LogEventTypes.Blob:
          return "Blob";
        case LogEventTypes.Cache:
          return "Cache";
        case LogEventTypes.Coder:
          return "Coder";
        case LogEventTypes.Configure:
          return "Configure";
        case LogEventTypes.Deprecate:
          return "Deprecate";
        case LogEventTypes.Draw:
          return "Draw";
        case LogEventTypes.Exception:
          return "Exception";
        case LogEventTypes.Image:
          return "Image";
        case LogEventTypes.Locale:
          return "Locale";
        case LogEventTypes.Module:
          return "Module";
        case LogEventTypes.Pixel:
          return "Pixel";
        case LogEventTypes.Policy:
          return "Policy";
        case LogEventTypes.Resource:
          return "Resource";
        case LogEventTypes.Trace:
          return "Trace";
        case LogEventTypes.Transform:
          return "Transform";
        case LogEventTypes.User:
          return "User";
        case LogEventTypes.Wand:
          return "Wand";
